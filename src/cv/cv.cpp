...
namespace grip {
    ...
    void GripPipeline::Process(cv::Mat& source0){
        ...
        double blurRadius = 8.444444444444448;  // default Double
        blur(blurInput, blurType, blurRadius, this->blurOutput);
        //Step RGB_Threshold0:
        //input
        cv::Mat rgbThresholdInput = blurOutput;
        double rgbThresholdRed[] = {35.07098491570541, 41.7672413793104};
        double rgbThresholdGreen[] = {41.85891748003549, 94.52586206896551};
        double rgbThresholdBlue[] = {53.172138420585625, 157.17672413793107};
